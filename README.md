...
The Appearance menu offers light, dark, and system themes, with locally remembered preferences. Faint contour lines flow through the desktop margins; readers can freeze or hide it. The default follows reduced motion; Moving explicitly enables animation. Hidden tabs and narrow screens do not animate. Code highlighting and category diagrams follow the theme; print stays light.
