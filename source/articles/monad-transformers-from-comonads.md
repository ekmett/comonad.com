[Last time](http://comonad.com/reader/2011/monads-from-comonads/), I showed that we can transform any Comonad in Haskell into a Monad in Haskell.
...
(This monad transformer is available in my [kan-extensions](http://hackage.haskell.org/package/kan-extensions) package as of 1.9.0 on hackage.)
